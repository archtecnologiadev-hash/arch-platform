...
(uid1,  'Schmitt & Corrêa Arquitetura',    'Carlos Schmitt',    'Blumenau',           'SC', '(47) 99201-3847', '@schmitt.arquitetura',
  ...
  'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&h=400&fit=crop&q=80', 'schmitt-correa-arquitetura'),
...
(uid2,  'Atelier Bäumer Design',           'Ana Bäumer',        'Pomerode',           'SC', '(47) 99342-5610', '@atelie.baumer',
  ...
  'https://images.unsplash.com/photo-1600607687939-ce8a6f349abc?w=800&h=400&fit=crop&q=80', 'atelier-baumer-design'),
...
(uid3,  'Ritter Projetos Arquitetônicos',  'Luís Ritter',       'Gaspar',             'SC', '(47) 99455-7823', '@ritter.projetos',
  ...
  'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=800&h=400&fit=crop&q=80', 'ritter-projetos-arquitetonicos'),
...
(uid4,  'Müller Arquitetura Sustentável',  'Fernanda Müller',   'Blumenau',           'SC', '(47) 99567-2190', '@muller.sustentavel',
  ...
  'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&h=400&fit=crop&q=80', 'muller-arquitetura-sustentavel'),
...
(uid5,  'Atelier Vale do Itajaí',          'Rodrigo Alves',     'Indaial',            'SC', '(47) 99618-4532', '@atelie.vale',
  ...
  'https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=800&h=400&fit=crop&q=80', 'atelier-vale-do-itajai'),
...
(uid6,  'Fischer & Krauss Arquitetura',    'Heinrich Fischer',  'Blumenau',           'SC', '(47) 99723-8901', '@fischer.krauss',
  ...
  'https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?w=800&h=400&fit=crop&q=80', 'fischer-krauss-arquitetura'),
...
(uid7,  'Estúdio Itajaí Contemporâneo',   'Beatriz Cunha',     'Itajaí',             'SC', '(47) 99834-6274', '@studio.itajai',
  ...
  'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=800&h=400&fit=crop&q=80', 'estudio-itajai-contemporaneo'),
...
(uid8,  'Hoffmann Arquitetura Criativa',   'Paulo Hoffmann',    'Timbó',              'SC', '(47) 99945-1837', '@hoffmann.arq',
  ...
  'https://images.unsplash.com/photo-1600573472550-8090b5e0745e?w=800&h=400&fit=crop&q=80', 'hoffmann-arquitetura-criativa'),
...
(uid9,  'Estúdio Formas Urbanas',          'Marina Torres',     'Blumenau',           'SC', '(47) 99012-5493', '@formas.urbanas',
  ...
  'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=800&h=400&fit=crop&q=80', 'estudio-formas-urbanas'),
...
(uid10, 'Neumann Arquitetura e Urbanismo', 'Gerhardt Neumann',  'Pomerode',           'SC', '(47) 99156-7802', '@neumann.urbanismo',
  ...
  'https://images.unsplash.com/photo-1600585154363-67eb9e2e2099?w=800&h=400&fit=crop&q=80', 'neumann-arquitetura-e-urbanismo'),
...
(uid11, 'Atelier Sul Design',              'Camila Santos',     'Brusque',            'SC', '(47) 99267-9341', '@atelie.suldesign',
  ...
  'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&h=400&fit=crop&q=80', 'atelier-sul-design'),
...
(uid12, 'Weber & Associados Arquitetura',  'Klaus Weber',       'Gaspar',             'SC', '(47) 99378-2658', '@weber.associados',
  ...
  'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=800&h=400&fit=crop&q=80', 'weber-associados-arquitetura'),
...
(uid13, 'Estúdio Rio do Sul Design',      'Paulo Melo',        'Rio do Sul',         'SC', '(47) 99489-3917', '@riodesul.design',
  ...
  'https://images.unsplash.com/photo-1416331108676-a22ccb276e35?w=800&h=400&fit=crop&q=80', 'estudio-rio-do-sul-design'),
...
(uid14, 'Klein Arquitetura Corporativa',   'Sandra Klein',      'Jaraguá do Sul',     'SC', '(47) 99590-4206', '@klein.corporativo',
  ...
  'https://images.unsplash.com/photo-1564078516393-cf04bd966897?w=800&h=400&fit=crop&q=80', 'klein-arquitetura-corporativa'),
...
(uid15, 'Atelier Balneário Projetos',      'Rafael Oliveira',   'Balneário Camboriú', 'SC', '(47) 99601-8745', '@atelie.balneario',
  ...
  'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800&h=400&fit=crop&q=80', 'atelier-balneario-projetos'),
...
(uid16, 'Becker Arquitetura Contemporânea','Thomas Becker',     'Blumenau',           'SC', '(47) 99712-5184', '@becker.contemporaneo',
  ...
  'https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=800&h=400&fit=crop&q=80', 'becker-arquitetura-contemporanea'),
...
(uid17, 'Estúdio Bremer & Figueiredo',    'Aline Bremer',      'Indaial',            'SC', '(47) 99823-6473', '@bremer.figueiredo',
  ...
  'https://images.unsplash.com/photo-1560448204-444da2e9ddc3?w=800&h=400&fit=crop&q=80', 'estudio-bremer-e-figueiredo'),
...
(uid18, 'Schulz Projetos e Espaços',      'Otto Schulz',       'Timbó',              'SC', '(47) 99934-7862', '@schulz.projetos',
  ...
  'https://images.unsplash.com/photo-1533779183-a4d2afe7ffe3?w=800&h=400&fit=crop&q=80', 'schulz-projetos-e-espacos'),
...
(uid19, 'Atelier Wittmann Design',         'Vera Wittmann',     'Blumenau',           'SC', '(47) 99045-9151', '@wittmann.design',
  ...
  'https://images.unsplash.com/photo-1556028888-0c54de1c1b66?w=800&h=400&fit=crop&q=80', 'atelier-wittmann-design'),
...
(uid20, 'Krause Arquitetura e Paisagismo', 'Heiko Krause',      'Blumenau',           'SC', '(47) 99156-0420', '@krause.paisagismo',
  ...
  'https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=800&h=400&fit=crop&q=80', 'krause-arquitetura-e-paisagismo');
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=900&h=600&fit=crop&q=80', 0),
  (pp, 'https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?w=900&h=600&fit=crop&q=80', 1),
  (pp, 'https://images.unsplash.com/photo-1600573472550-8090b5e0745e?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600607687939-ce8a6f349abc?w=900&h=600&fit=crop&q=80', 0),
  (pp, 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop&q=80', 1),
  (pp, 'https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=900&h=600&fit=crop&q=80', 0),
  (pp, 'https://images.unsplash.com/photo-1564078516393-cf04bd966897?w=900&h=600&fit=crop&q=80', 1),
  (pp, 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600607687939-ce8a6f349abc?w=900&h=600&fit=crop&q=80', 0),
  (pp, 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=900&h=600&fit=crop&q=80', 1),
  (pp, 'https://images.unsplash.com/photo-1560448204-444da2e9ddc3?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=900&h=600&fit=crop&q=80', 0),
  (pp, 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=900&h=600&fit=crop&q=80', 1),
  (pp, 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1556028888-0c54de1c1b66?w=900&h=600&fit=crop&q=80', 0),
  (pp, 'https://images.unsplash.com/photo-1533779183-a4d2afe7ffe3?w=900&h=600&fit=crop&q=80', 1),
  (pp, 'https://images.unsplash.com/photo-1416331108676-a22ccb276e35?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=900&h=600&fit=crop&q=80', 0),
  (pp, 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=900&h=600&fit=crop&q=80', 1),
  (pp, 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600585154363-67eb9e2e2099?w=900&h=600&fit=crop&q=80', 0),
  (pp, 'https://images.unsplash.com/photo-1596522354895-6bda26e96893?w=900&h=600&fit=crop&q=80', 1),
  (pp, 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1564078516393-cf04bd966897?w=900&h=600&fit=crop&q=80', 0),
  (pp, 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=900&h=600&fit=crop&q=80', 1),
  (pp, 'https://images.unsplash.com/photo-1600607687939-ce8a6f349abc?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=900&h=600&fit=crop&q=80', 0),
  (pp, 'https://images.unsplash.com/photo-1600585154363-67eb9e2e2099?w=900&h=600&fit=crop&q=80', 1),
  (pp, 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1596522354895-6bda26e96893?w=900&h=600&fit=crop&q=80', 0),
  (pp, 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=900&h=600&fit=crop&q=80', 1),
  (pp, 'https://images.unsplash.com/photo-1416331108676-a22ccb276e35?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=900&h=600&fit=crop&q=80', 0),
  (pp, 'https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?w=900&h=600&fit=crop&q=80', 1),
  (pp, 'https://images.unsplash.com/photo-1533779183-a4d2afe7ffe3?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=900&h=600&fit=crop&q=80', 0),
  (pp, 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop&q=80', 1),
  (pp, 'https://images.unsplash.com/photo-1600573472550-8090b5e0745e?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600607687939-ce8a6f349abc?w=900&h=600&fit=crop&q=80', 0),
  (pp, 'https://images.unsplash.com/photo-1556028888-0c54de1c1b66?w=900&h=600&fit=crop&q=80', 1),
  (pp, 'https://images.unsplash.com/photo-1560448204-444da2e9ddc3?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=900&h=600&fit=crop&q=80', 0),
  (pp, 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=900&h=600&fit=crop&q=80', 1),
  (pp, 'https://images.unsplash.com/photo-1564078516393-cf04bd966897?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1533779183-a4d2afe7ffe3?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1564078516393-cf04bd966897?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1416331108676-a22ccb276e35?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1596522354895-6bda26e96893?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1600585154363-67eb9e2e2099?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600607687939-ce8a6f349abc?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1560448204-444da2e9ddc3?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1533779183-a4d2afe7ffe3?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1416331108676-a22ccb276e35?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600573472550-8090b5e0745e?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1560448204-444da2e9ddc3?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1596522354895-6bda26e96893?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1564078516393-cf04bd966897?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1533779183-a4d2afe7ffe3?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1416331108676-a22ccb276e35?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1596522354895-6bda26e96893?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1600585154363-67eb9e2e2099?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES
  (pp, 'https://images.unsplash.com/photo-1564078516393-cf04bd966897?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1600607687939-ce8a6f349abc?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1596522354895-6bda26e96893?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1600607687939-ce8a6f349abc?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1560448204-444da2e9ddc3?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1600585154363-67eb9e2e2099?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1533779183-a4d2afe7ffe3?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1416331108676-a22ccb276e35?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1564078516393-cf04bd966897?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1596522354895-6bda26e96893?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1600573472550-8090b5e0745e?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1600607687939-ce8a6f349abc?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1416331108676-a22ccb276e35?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1560448204-444da2e9ddc3?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1533779183-a4d2afe7ffe3?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1564078516393-cf04bd966897?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1416331108676-a22ccb276e35?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1533779183-a4d2afe7ffe3?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1596522354895-6bda26e96893?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1600585154363-67eb9e2e2099?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1600607687939-ce8a6f349abc?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1560448204-444da2e9ddc3?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1416331108676-a22ccb276e35?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1533779183-a4d2afe7ffe3?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1556028888-0c54de1c1b66?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1600573472550-8090b5e0745e?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1560448204-444da2e9ddc3?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1600573472550-8090b5e0745e?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1596522354895-6bda26e96893?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1600585154363-67eb9e2e2099?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1533779183-a4d2afe7ffe3?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1596522354895-6bda26e96893?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1416331108676-a22ccb276e35?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1556028888-0c54de1c1b66?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1600607687939-ce8a6f349abc?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1564078516393-cf04bd966897?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1560448204-444da2e9ddc3?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1600585154363-67eb9e2e2099?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1596522354895-6bda26e96893?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1533779183-a4d2afe7ffe3?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=900&h=600&fit=crop&q=80', 2);
...
INSERT INTO public.portfolio_imagens (projeto_portfolio_id, url, ordem) VALUES (pp, 'https://images.unsplash.com/photo-1416331108676-a22ccb276e35?w=900&h=600&fit=crop&q=80', 0), (pp, 'https://images.unsplash.com/photo-1600585154363-67eb9e2e2099?w=900&h=600&fit=crop&q=80', 1), (pp, 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=900&h=600&fit=crop&q=80', 2);
...
(fuid1,  'Marcenaria Tischler',         'Marcenaria', 'Blumenau',
  ...
  'https://images.unsplash.com/photo-1556028888-0c54de1c1b66?w=800&h=400&fit=crop&q=80', 'marcenaria-tischler'),
(fuid2,  'Volthaus Elétrica',           'Elétrica',   'Blumenau',
  ...
  'https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?w=800&h=400&fit=crop&q=80', 'volthaus-eletrica'),
(fuid3,  'Kristall Vidraçaria',         'Vidraçaria', 'Pomerode',
  ...
  'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=800&h=400&fit=crop&q=80', 'kristall-vidracaria'),
(fuid4,  'Weiss Gesseiro',              'Gesseiro',   'Gaspar',
  ...
  'https://images.unsplash.com/photo-1600607687939-ce8a6f349abc?w=800&h=400&fit=crop&q=80', 'weiss-gesseiro'),
(fuid5,  'Farbhaus Tintas',             'Pintura',    'Blumenau',
  ...
  'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=800&h=400&fit=crop&q=80', 'farbhaus-tintas'),
(fuid6,  'Lumina Iluminação',           'Iluminação', 'Itajaí',
  ...
  'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=800&h=400&fit=crop&q=80', 'lumina-iluminacao'),
(fuid7,  'HidroVale Instalações',       'Hidráulica', 'Indaial',
  ...
  'https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=800&h=400&fit=crop&q=80', 'hidrovale-instalacoes'),
(fuid8,  'Böden Pisos e Revestimentos', 'Pisos',      'Timbó',
  ...
  'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&h=400&fit=crop&q=80', 'boden-pisos-e-revestimentos'),
(fuid9,  'Vorhang Cortinas',            'Cortinas',   'Blumenau',
  ...
  'https://images.unsplash.com/photo-1560448204-444da2e9ddc3?w=800&h=400&fit=crop&q=80', 'vorhang-cortinas'),
(fuid10, 'Stilvoll Decoração',          'Decoração',  'Jaraguá do Sul',
  ...
  'https://images.unsplash.com/photo-1564078516393-cf04bd966897?w=800&h=400&fit=crop&q=80', 'stilvoll-decoracao');
...
INSERT INTO public.fornecedor_produto_imagens (produto_id, url, ordem) VALUES (prod, 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=300&h=300&fit=crop&q=80', 0), (prod, 'https://images.unsplash.com/photo-1556028888-0c54de1c1b66?w=300&h=300&fit=crop&q=80', 1);
...
INSERT INTO public.fornecedor_produto_imagens (produto_id, url, ordem) VALUES (prod, 'https://images.unsplash.com/photo-1600573472550-8090b5e0745e?w=300&h=300&fit=crop&q=80', 0), (prod, 'https://images.unsplash.com/photo-1560448204-444da2e9ddc3?w=300&h=300&fit=crop&q=80', 1);
...
INSERT INTO public.fornecedor_produto_imagens (produto_id, url, ordem) VALUES (prod, 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=300&h=300&fit=crop&q=80', 0), (prod, 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=300&h=300&fit=crop&q=80', 1);
...
INSERT INTO public.fornecedor_produto_imagens (produto_id, url, ordem) VALUES (prod, 'https://images.unsplash.com/photo-1564078516393-cf04bd966897?w=300&h=300&fit=crop&q=80', 0), (prod, 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=300&h=300&fit=crop&q=80', 1);
...
INSERT INTO public.fornecedor_produto_imagens (produto_id, url, ordem) VALUES (prod, 'https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=300&h=300&fit=crop&q=80', 0), (prod, 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&h=300&fit=crop&q=80', 1);
...
INSERT INTO public.fornecedor_produto_imagens (produto_id, url, ordem) VALUES (prod, 'https://images.unsplash.com/photo-1600607687939-ce8a6f349abc?w=300&h=300&fit=crop&q=80', 0);
...
INSERT INTO public.fornecedor_produto_imagens (produto_id, url, ordem) VALUES (prod, 'https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?w=300&h=300&fit=crop&q=80', 0);
...
INSERT INTO public.fornecedor_produto_imagens (produto_id, url, ordem) VALUES (prod, 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=300&h=300&fit=crop&q=80', 0);
...
INSERT INTO public.fornecedor_produto_imagens (produto_id, url, ordem) VALUES (prod, 'https://images.unsplash.com/photo-1533779183-a4d2afe7ffe3?w=300&h=300&fit=crop&q=80', 0);
...
INSERT INTO public.fornecedor_produto_imagens (produto_id, url, ordem) VALUES (prod, 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=300&h=300&fit=crop&q=80', 0), (prod, 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=300&h=300&fit=crop&q=80', 1);
...
INSERT INTO public.fornecedor_produto_imagens (produto_id, url, ordem) VALUES (prod, 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=300&h=300&fit=crop&q=80', 0), (prod, 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=300&h=300&fit=crop&q=80', 1);
...
INSERT INTO public.fornecedor_produto_imagens (produto_id, url, ordem) VALUES (prod, 'https://images.unsplash.com/photo-1560448204-444da2e9ddc3?w=300&h=300&fit=crop&q=80', 0);
...
INSERT INTO public.fornecedor_produto_imagens (produto_id, url, ordem) VALUES (prod, 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=300&h=300&fit=crop&q=80', 0), (prod, 'https://images.unsplash.com/photo-1564078516393-cf04bd966897?w=300&h=300&fit=crop&q=80', 1);
