  ...
  return (
    <aside style={{
      ...
      <div style={{
        ...
        <span style={{ fontSize: 18, fontWeight: 300, letterSpacing: '0.35em', color: '#007AFF' }}>
          ARC
        </span>
        <span style={{
          fontSize: 9, color: '#8e8e93', letterSpacing: '0.15em',
          fontWeight: 500, marginTop: 3, textTransform: 'uppercase' as const,
        }}>
          Cliente
        </span>
      </div>
